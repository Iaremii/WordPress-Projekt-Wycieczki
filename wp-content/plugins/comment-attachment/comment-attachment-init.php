    ...
    class wpCommentAttachment
    {
        ...
        public function displayFormAtt()
        {
            ...
            echo '<p class="comment-form-url comment-form-attachment">'.
                '<label for="attachment">' . ATT_TITLE . $required .'<small class="attachmentRules">('.__('Możesz dodac takie pliki jak:','comment-attachment').': <strong>'. $this->displayAllowedFileTypes() .'</strong>, '.__('o rozmiarze nie wieciej niź','comment-attachment').': <strong>'. ATT_MAX .'MB.&nbsp;&nbsp;<input id="attachment" name="attachment" type="file" /></strong></small></label>'.
                '</p>';
