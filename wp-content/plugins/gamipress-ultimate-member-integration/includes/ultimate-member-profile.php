...
function gamipress_ultimate_member_user_profile_tabs( $tabs ) {
    ...
    // Points tab
    $points_placement = gamipress_ultimate_member_get_option( 'points_placement', 'tab' );
    ...
    // Achievements tab
    $achievements_placement = gamipress_ultimate_member_get_option( 'achievements_placement', 'tab' );
    ...
    // Ranks tab
    $ranks_placement = gamipress_ultimate_member_get_option( 'ranks_placement', 'tab' );
