...
final class GamiPress_Ultimate_Member {
    ...
    private function constants() {
        ...
        // Plugin version
        define( 'GAMIPRESS_ULTIMATE_MEMBER_VER', '1.0.0' );
    ...
    public function admin_notices() {
        ...
        <?php elseif ( is_multisite() && version_compare( GAMIPRESS_VER, '1.4.8', '<' ) ) : ?>
            ...
            <div id="message" class="notice notice-error is-dismissible">
                <p>
                    <?php printf(
                        __( 'GamiPress - Ultimate Member integration requires %s or higher in order to enable multisite features. Please update your GamiPress install.', 'gamipress-ultimate-member-integration' ),
